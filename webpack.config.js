(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["table-data"] = factory(require("react"));
	else
		root["table-data"] = factory(root["React"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tableData = __webpack_require__(8);

	var _tableData2 = _interopRequireDefault(_tableData);

	var _tableDataMixin = __webpack_require__(9);

	var _tableDataMixin2 = _interopRequireDefault(_tableDataMixin);

	var _tableDataSource = __webpack_require__(4);
	...
	var _searchField = __webpack_require__(11);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sortHeaderColumn = __webpack_require__(7);
	  ...
	  _createClass(Table, [{
	    ...
	    value: function buildHeaders() {
	      ...
	      return columns.map(function (col, i) {
	        if (col.sortable) {
	          return _react2.default.createElement(_sortHeaderColumn2.default, {
	            key: i,
	            column: col,
	            sortBy: sortBy,
	            onSort: onSort }, _react2.default.createElement('span', null, col.title));
	        }
	        ...
	        return _react2.default.createElement(_column2.default, {
	          ...
	          sortBy: sortBy,
	          onSort: onSort,
	          isHeader: true }, _react2.default.createElement('span', null, col.title));
	      });
	    }
	  }, {
	    key: 'buildRows',
	    value: function buildRows() {
	      ...
	      if (dataSource.rows().length === 0) {
	        return _react2.default.createElement('tr', null, _react2.default.createElement('td', { colSpan: columns.length, className: 'text-center' }, 'No data'));
	      }

	      return dataSource.rows().map(function (row, k) {
	        return _react2.default.createElement('tr', { key: k }, columns.map(function (col, i) {
	          return _react2.default.createElement(_column2.default, { key: i }, getCellValue(col, row));
	        }));
	      });
	    }
	  }, {
	    ...
	    value: function render() {
	      return _react2.default.createElement('table', this.props, _react2.default.createElement('thead', null, _react2.default.createElement('tr', null, this.buildHeaders())), _react2.default.createElement('tbody', null, this.buildRows()));
	    }
	  }]);
	...
	var Column = function (_Component) {
	  ...
	  _createClass(Column, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(Cell, extraProps, children);
	    }
	  }]);
	...
	var SortHeaderColumn = function (_Component) {
	  ...
	  _createClass(SortHeaderColumn, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement('th', _extends({ className: 'sortable', role: 'columnheader', scope: 'col', style: { width: column.width } }, sortProps), children, typeof order !== 'undefined' ? _react2.default.createElement('span', { className: 'sort-icon sort-' + order, 'aria-hidden': 'true' }) : null);
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DataTable = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement('div', { className: this.props.className }, _react2.default.createElement(_searchField2.default, {
	      id: 'search-field',
	      label: 'Search:',
	      ...
	      onSort: this.onSort }), _react2.default.createElement(_pagination2.default, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchField = function (_Component) {
	  ...
	  _createClass(SearchField, [{
	    ...
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement('div', null, _react2.default.createElement('label', { htmlFor: this.props.id }, this.props.label), _react2.default.createElement('input', {
